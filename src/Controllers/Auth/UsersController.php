...
class UsersController extends RootAdminController
{
    ...
    public function edit($id)
    {
        ...
        if ($user === null) {
            return redirect(gp247_route_admin('admin_role.index'))->with('error', gp247_language_render('admin.display.data_not_found'));
            return gp247_language_render('admin.display.data_not_found_detail');
        }
