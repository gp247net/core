<?php
if (file_exists(app_path('GP247/Core/Admin/Controllers/Auth/PermissionController.php'))) {
    $nameSpaceAdminPermission = 'App\GP247\Core\Admin\Controllers';
} else {
    $nameSpaceAdminPermission = 'GP247\Core\Admin\Controllers';
}
