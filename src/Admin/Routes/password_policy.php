<?php
if (file_exists(app_path('GP247/Core/Admin/Controllers/AdminPasswordPolicyController.php'))) {
    $nameSpaceAdminStoreConfig = 'App\GP247\Core\Admin\Controllers';
} else {
    $nameSpaceAdminStoreConfig = 'GP247\Core\Admin\Controllers';
}
