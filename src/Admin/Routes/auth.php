<?php
if (file_exists(app_path('GP247/Core/Admin/Controllers/Auth/LoginController.php'))) {
    $nameSpaceAdminAuth = 'App\GP247\Core\Admin\Controllers';
} else {
    $nameSpaceAdminAuth = 'GP247\Core\Admin\Controllers';
}
