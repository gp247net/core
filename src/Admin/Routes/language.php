<?php
if (file_exists(app_path('GP247/Core/Admin/Controllers/AdminLanguageController.php'))) {
    $nameSpaceAdminLang = 'App\GP247\Core\Admin\Controllers';
} else {
    $nameSpaceAdminLang = 'GP247\Core\Admin\Controllers';
}
