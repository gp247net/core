<?php
if (file_exists(app_path('GP247/Core/Admin/Controllers/AdminMenuController.php'))) {
    $nameSpaceAdminMenu = 'App\GP247\Core\Admin\Controllers';
} else {
    $nameSpaceAdminMenu = 'GP247\Core\Admin\Controllers';
}
