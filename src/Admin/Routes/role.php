<?php
if (file_exists(app_path('GP247/Core/Admin/Controllers/Auth/RoleController.php'))) {
    $nameSpaceAdminRole = 'App\GP247\Core\Admin\Controllers';
} else {
    $nameSpaceAdminRole = 'GP247\Core\Admin\Controllers';
}
