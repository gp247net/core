<?php
if (file_exists(app_path('GP247/Core/Admin/Controllers/AdminCustomFieldController.php'))) {
    $nameSpaceAdminCustomField = 'App\GP247\Core\Admin\Controllers';
} else {
    $nameSpaceAdminCustomField = 'GP247\Core\Admin\Controllers';
}
