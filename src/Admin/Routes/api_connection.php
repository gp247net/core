<?php
if (file_exists(app_path('GP247/Core/Admin/Controllers/AdminApiConnectionController.php'))) {
    $nameSpaceAdminApi = 'App\GP247\Core\Admin\Controllers';
} else {
    $nameSpaceAdminApi = 'GP247\Core\Admin\Controllers';
}
