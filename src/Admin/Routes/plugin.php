<?php
if (file_exists(app_path('GP247/Core/Admin/Controllers/AdminPluginsController.php'))) {
    $nameSpaceAdminPlugin = 'App\GP247\Core\Admin\Controllers';
} else {
    $nameSpaceAdminPlugin = 'GP247\Core\Admin\Controllers';
}
