...
Route::group(
    ...
    function () {
        ...
        if (file_exists(app_path('GP247/Core/Admin/Controllers/HomeController.php'))) {
            $nameSpaceHome = 'App\GP247\Core\Admin\Controllers';
        } else {
            $nameSpaceHome = 'GP247\Core\Admin\Controllers';
        }
