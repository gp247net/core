...
class DataDefaultSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $db->table(GP247_DB_PREFIX.'admin_home')->insertOrIgnore(
            [
                ['size' => 12, 'sort'=> 0,'view' => 'gp247-core::component.home_footer','status' => 1],
                ['size' => 12, 'sort'=> 1,'view' => 'gp247-core::component.home_default','status' => 1],
            ]
        );
    ...
    public function dataAdminStore($email, $language, $domain) {
        $dataAdminStore = [
            ['id' => 1,'logo' => '/GP247/Core/logo/logo.png', 'icon' => '/GP247/Core/logo/icon.png', 'og_image' => '/GP247/Core/logo/logo.png', 'phone' => '0123456789','long_phone' => 'Support: 0987654321','email' => $email,'time_active' =>'','address' => '123st - abc - xyz','language' => $language,'currency' => 'USD','code' => 'gp247','domain' => $domain]
        ];
    ...
    public function dataAdminStoreDescription($titleE, $titleV) {
        $dataAdminStoreDescription = [
            ['store_id' => GP247_ID_ROOT,'lang' => 'en','title' => $titleE,'description' => '','keyword' => '','maintain_content' => '<center><img src="/GP247/Core/images/maintenance.jpg" />
            <h3><span style="color:#e74c3c;"><strong>Sorry! We are currently doing site maintenance!</strong></span></h3>
            </center>','maintain_note' => 'Website is in maintenance mode!'],
            ['store_id' => GP247_ID_ROOT,'lang' => 'vi','title' => $titleV,'description' => '','keyword' => '','maintain_content' => '<center><img src="/GP247/Core/images/maintenance.jpg" />
