        ...
        <div class="card-tools">
         ...
         <div class="float-left">
          @if (!empty($removeList))
            ...
            <div class="menu-left">
              <span class="btn btn-sm btn-flat btn-danger grid-trash" title="{{ gp247_language_render('action.delete') }}"><i class="fas fa-trash-alt"></i></span>
            </div>
          @endif

          @if (!empty($buttonRefresh))
            <div class="menu-left">
              <span class="btn btn-sm btn-flat btn-primary grid-refresh" title="{{ gp247_language_render('action.refresh') }}"><i class="fas fa-sync-alt"></i></span>
            </div>
          @endif
