                            ...
                            <div class="card-body">
                                <div
                                    ...
                                    <label for="{{ $code }}__maintain_content"
                                        class="col-sm-2 col-form-label">{{ gp247_language_render('admin.maintain.description') }}</label>
                                    <div class="col-sm-8">
                                ...
                                <label for="{{ $code }}__maintain_note"
                                    class="col-sm-2 col-form-label">{{ gp247_language_render('admin.maintain.description_note') }}</label>
                                <div class="col-sm-8">
                                    <input id="{{ $code }}__maintain_note" type="text" class="form-control form-control-sm input-sm"
...
<script type="text/javascript">
    ...
    {
        filebrowserImageBrowseUrl: '{{ gp247_route_admin('admin.home').'/'.config('lfm.url_prefix') }}?type=content',
        filebrowserImageUploadUrl: '{{ gp247_route_admin('admin.home').'/'.config('lfm.url_prefix') }}/upload?type=content&_token={{csrf_token()}}',
