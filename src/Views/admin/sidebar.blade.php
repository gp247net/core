  ...
  <aside class="main-sidebar sidebar-light-pink elevation-4 sidebar-no-expand">
    ...
    <a href="{{ gp247_route_admin('admin.home') }}" class="brand-link" style="padding: 2px">
      <img src="{{ gp247_file(gp247_store_info('logo')) }}" alt="{!! gp247_config_admin('ADMIN_NAME') !!}" 
    style="
      max-height: 55px;
      width: auto;
      margin: 0 auto;
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-legacy" data-widget="treeview" role="menu">
          ...
          <li class="nav-link header">
            ...
            <p class="sub-header">{!! gp247_language_render($level0->title) !!}</p>
          </li>
          ...
          <li class="nav-item {{ \GP247\Core\Admin\Models\AdminMenu::checkUrlIsChild(url()->current(), gp247_url_render($level1->uri)) ? 'active' : '' }}">
            <a href="{{ $level1->uri?gp247_url_render($level1->uri):'#' }}" class="nav-link">
              ...
              <p>
                {!! gp247_language_render($level1->title) !!}
              </p>
            </a>
          </li>
          @else
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item has-treeview">
                <a href="#" class="nav-link">
                  ...
                  <p>
                    {!! gp247_language_render($level2->title) !!}
                    <i class="right fas fa-angle-left"></i>
                  </p>
                </a>
                ...
                <ul class="nav nav-treeview">
                  ...
                  <li class="nav-item has-treeview">
                    <a href="#" class="nav-link">
                      ...
                      <p>
                        {!! gp247_language_render($level3->title) !!}
                        <i class="right fas fa-angle-left"></i>
                      </p>
                    </a>
                  </li>
